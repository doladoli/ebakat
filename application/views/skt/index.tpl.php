		 ...
		 <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
				  ...
				  <div class="tab-pane <?php ++$i; if ($i==1) {?>active<?php }?>" id="tab_<?=$k->KR_ID?>">
					<?php echo_table_title("Kriteria  ".$k->KR_KOD." : ".$k->KR_KETERANGAN, true, "open_modal(".$k->KR_ID.");")?>
					<?php
						$ppk = ""; $ppp = "";
                    ...
                    <div class="box-body table-responsive no-padding">
						...
						<table id="sp_list_<?=$k->KR_ID?>" width="100%" class="table table-hover table-bordered table-striped">	
							...
							<tbody>
							<?php echo $this->load->view("skt/listskt.tpl.php", array("skt"=>$skt));?>
							</tbody>
						</table>
					</div>
                  </div><!-- /.tab-pane -->
                  ...
                  <form role="form"> 
                    <div class="form-group">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"/>
                          Saya bersetuju untuk menghantar keterangan sasaran kerja tahunan ini kepada pegawai penilai pertama yang telah ditetapkan
                        </label>
                      </div>
					
					</div>
					 <button id="btn_hantar" class="btn bg-maroon btn-flat margin pull-right">Hantar</button>				
					</form>
				</div>
		 </div>
	</div>
...
$(document).ready(function() {
	...
	$("#btn_hantar").click(function(){
		if(confirm("Anda pasti untuk menghantar sasaran kerja tahunan ni kepada pegawai penilai pertama?")) {
