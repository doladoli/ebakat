		...
		<form method="post">
		 <div class="nav-tabs-custom">
				...
				<?php $i=0; foreach($sub->result() as $k){?>
                  <li <?php ++$i; if ($i==3) {?> class="active" <?php }?>><a href="#tab_<?=$k->KR_ID?>" data-toggle="tab"><?=$k->KR_KETERANGAN?></a></li>
				<?php }  ?>
                ...
                <div class="tab-content">
                  <?php $i=0; foreach($sub->result() as $k){?>
				  <div class="tab-pane <?php ++$i; if ($i==3) {?>active<?php }?>" id="tab_<?=$k->KR_ID?>">
                    ...
                    <div class="box-body table-responsive no-padding">
						...
						<?php
							...
							__jana($k->KR_ID, $this->pm, $this->corek1, 3);
						?>
